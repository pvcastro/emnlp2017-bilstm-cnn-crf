...
datasetName = 'HAREM'
dataColumns = {0:'tokens', 1:'NER_BIO'} #Tab separated columns, column 0 contains the token, 1 the NER using BIO-encoding
labelKey = 'NER_BIO'

embeddingsPath = 'embeddings/fasttext_s100.txt' #Word embeddings by Reimers et al: https://www.ukp.tu-darmstadt.de/research/ukp-in-challenges/germeval-2014/
...
frequencyThresholdUnknownTokens = None #If a token that is not in the pre-trained embeddings file appears at least 50 times in the train.txt, then a new embedding is generated for this word
